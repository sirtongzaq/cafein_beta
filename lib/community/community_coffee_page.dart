...
class CommunityCoffeePage extends StatefulWidget {
  const CommunityCoffeePage({super.key});

  @override
  State<CommunityCoffeePage> createState() => _CommunityCoffeePageState();
}

class _CommunityCoffeePageState extends State<CommunityCoffeePage> {
  final maxLines = 5;
