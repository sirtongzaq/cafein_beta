...
class CommunitySeedPage extends StatefulWidget {
  const CommunitySeedPage({super.key});

  @override
  State<CommunitySeedPage> createState() => _CommunitySeedPageState();
}

class _CommunitySeedPageState extends State<CommunitySeedPage> {
  final maxLines = 5;
