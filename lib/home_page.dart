              ...
              child: Column(
                children: <Widget>[
                  ...
                  Padding( // CONTENT header
                    ...
                    child: Align(
                      alignment: Alignment.topLeft,
                      child: Text("CONTENT",style: TextStyle(color: SecondColor,fontSize: 15),)
                      ),
                  ),
                ],
              ),
