...
class AbeMapPage extends StatefulWidget {
  const AbeMapPage({super.key});

  @override
  State<AbeMapPage> createState() => _AbeMapPageState();
}

class _AbeMapPageState extends State<AbeMapPage> {
  ...
  static const LatLng destination = LatLng(15.23213662, 104.8558509);
