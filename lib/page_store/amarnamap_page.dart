...
class AmarnaMapPage extends StatefulWidget {
  const AmarnaMapPage({super.key});

  @override
  State<AmarnaMapPage> createState() => _AmarnaMapPageState();
}

class _AmarnaMapPageState extends State<AmarnaMapPage> {
