...
class AnnaMapPage extends StatefulWidget {
  const AnnaMapPage({super.key});

  @override
  State<AnnaMapPage> createState() => _AnnaMapPageState();
}

class _AnnaMapPageState extends State<AnnaMapPage> {
  ...
  static const LatLng destination = LatLng(15.23329305, 104.8659386);
