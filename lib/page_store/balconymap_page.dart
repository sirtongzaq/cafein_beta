...
class BalconyMapPage extends StatefulWidget {
  const BalconyMapPage({super.key});

  @override
  State<BalconyMapPage> createState() => _BalconyMapPageState();
}

class _BalconyMapPageState extends State<BalconyMapPage> {
  ...
  static const LatLng destination = LatLng(15.23294259, 104.8621598);
