...
class BannMapPage extends StatefulWidget {
  const BannMapPage({super.key});

  @override
  State<BannMapPage> createState() => _BannMapPagePageState();
}

class _BannMapPagePageState extends State<BannMapPage> {
  ...
  static const LatLng destination = LatLng(15.17330272, 104.8559965);
