...
class BluescoffeeMapPage extends StatefulWidget {
  const BluescoffeeMapPage({super.key});

  @override
  State<BluescoffeeMapPage> createState() => _BluescoffeeMapPageState();
}

class _BluescoffeeMapPageState extends State<BluescoffeeMapPage> {
  ...
  static const LatLng destination = LatLng(15.23372683, 104.8709739);
