...
class BossaMapPage extends StatefulWidget {
  const BossaMapPage({super.key});

  @override
  State<BossaMapPage> createState() => _BossaMapPageState();
}

class _BossaMapPageState extends State<BossaMapPage> {
  ...
  static const LatLng destination = LatLng(15.27623263, 104.8274566);
