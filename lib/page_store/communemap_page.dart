...
class CommuneMapPage extends StatefulWidget {
  const CommuneMapPage({super.key});

  @override
  State<CommuneMapPage> createState() => _CommuneMapPageState();
}

class _CommuneMapPageState extends State<CommuneMapPage> {
  ...
  static const LatLng destination = LatLng(15.27267025, 104.853585);
