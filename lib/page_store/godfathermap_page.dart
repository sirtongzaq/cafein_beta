...
class GodfatherMapPage extends StatefulWidget {
  const GodfatherMapPage({super.key});

  @override
  State<GodfatherMapPage> createState() => _GodfatherMapPageState();
}

class _GodfatherMapPageState extends State<GodfatherMapPage> {
  ...
  static const LatLng destination = LatLng(15.23455522, 104.8483468);
