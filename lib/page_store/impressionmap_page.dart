...
class ImpressionMapPage extends StatefulWidget {
  const ImpressionMapPage({super.key});

  @override
  State<ImpressionMapPage> createState() => _ImpressionMapPageState();
}

class _ImpressionMapPageState extends State<ImpressionMapPage> {
  ...
  static const LatLng destination = LatLng(15.23196019, 104.8544833);
