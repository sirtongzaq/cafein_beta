...
class LavaMapPage extends StatefulWidget {
  const LavaMapPage({super.key});

  @override
  State<LavaMapPage> createState() => _LavaMapPageState();
}

class _LavaMapPageState extends State<LavaMapPage> {
  ...
  static const LatLng destination = LatLng(15.2333707, 104.8640172);
