...
class MindkMapPage extends StatefulWidget {
  const MindkMapPage({super.key});

  @override
  State<MindkMapPage> createState() => _MindkMapPageState();
}

class _MindkMapPageState extends State<MindkMapPage> {
  ...
  static const LatLng destination = LatLng(15.23309565, 104.8630897);
