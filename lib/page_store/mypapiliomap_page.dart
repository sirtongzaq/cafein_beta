...
class MypapilioMapPage extends StatefulWidget {
  const MypapilioMapPage({super.key});

  @override
  State<MypapilioMapPage> createState() => _MypapilioMapPageState();
}

class _MypapilioMapPageState extends State<MypapilioMapPage> {
  ...
  static const LatLng destination = LatLng(15.23571624, 104.8514289);
