...
class NapcoffeeMapPage extends StatefulWidget {
  const NapcoffeeMapPage({super.key});

  @override
  State<NapcoffeeMapPage> createState() => _NapcoffeeMapPageState();
}

class _NapcoffeeMapPageState extends State<NapcoffeeMapPage> {
  ...
  static const LatLng destination = LatLng(15.22891997, 104.8653647);
