...
class PenserMapPage extends StatefulWidget {
  const PenserMapPage({super.key});

  @override
  State<PenserMapPage> createState() => _PenserMapPageState();
}

class _PenserMapPageState extends State<PenserMapPage> {
  ...
  static const LatLng destination = LatLng(15.2447556, 104.8488483);
