...
class PhantaeMapPage extends StatefulWidget {
  const PhantaeMapPage({super.key});

  @override
  State<PhantaeMapPage> createState() => _PhantaeMapPageState();
}

class _PhantaeMapPageState extends State<PhantaeMapPage> {
  ...
  static const LatLng destination = LatLng(15.20207505, 104.8627049);
