...
class RedMapPage extends StatefulWidget {
  const RedMapPage({super.key});

  @override
  State<RedMapPage> createState() => _RedMapPageState();
}

class _RedMapPageState extends State<RedMapPage> {
  ...
  static const LatLng destination = LatLng(15.22600266, 104.8592925);
