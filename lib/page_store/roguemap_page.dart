...
class RogueMapPage extends StatefulWidget {
  const RogueMapPage({super.key});

  @override
  State<RogueMapPage> createState() => _RogueMapPageState();
}

class _RogueMapPageState extends State<RogueMapPage> {
  ...
  static const LatLng destination = LatLng(15.19496295, 104.8656565);
