...
class RosieholmMapPage extends StatefulWidget {
  const RosieholmMapPage({super.key});

  @override
  State<RosieholmMapPage> createState() => _RosieholmMapPageState();
}

class _RosieholmMapPageState extends State<RosieholmMapPage> {
  ...
  static const LatLng destination = LatLng(15.23428101, 104.8466579);
