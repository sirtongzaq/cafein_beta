...
class SaereesookMapPage extends StatefulWidget {
  const SaereesookMapPage({super.key});

  @override
  State<SaereesookMapPage> createState() => _SaereesookMapPageState();
}

class _SaereesookMapPageState extends State<SaereesookMapPage> {
  ...
  static const LatLng destination = LatLng(15.25747617, 104.8512588);
