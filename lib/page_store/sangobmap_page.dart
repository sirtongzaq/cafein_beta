...
class SangobMapPage extends StatefulWidget {
  const SangobMapPage({super.key});

  @override
  State<SangobMapPage> createState() => _SangobMapPageState();
}

class _SangobMapPageState extends State<SangobMapPage> {
  ...
  static const LatLng destination = LatLng(15.22538948, 104.8593951);
