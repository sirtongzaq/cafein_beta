...
class SnoopcatMapPage extends StatefulWidget {
  const SnoopcatMapPage({super.key});

  @override
  State<SnoopcatMapPage> createState() => _SnoopcatMapPageState();
}

class _SnoopcatMapPageState extends State<SnoopcatMapPage> {
  ...
  static const LatLng destination = LatLng(15.23582635, 104.8562541);
