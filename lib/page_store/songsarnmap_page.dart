...
class SongsarnMapPage extends StatefulWidget {
  const SongsarnMapPage({super.key});

  @override
  State<SongsarnMapPage> createState() => _SongsarnMapPageState();
}

class _SongsarnMapPageState extends State<SongsarnMapPage> {
  ...
  static const LatLng destination = LatLng(15.22541616, 104.858555);
