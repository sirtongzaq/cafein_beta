...
class StufeMapPage extends StatefulWidget {
  const StufeMapPage({super.key});

  @override
  State<StufeMapPage> createState() => _StufeMapPageState();
}

class _StufeMapPageState extends State<StufeMapPage> {
  ...
  static const LatLng destination = LatLng(15.23760081, 104.8573909);
