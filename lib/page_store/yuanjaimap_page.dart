...
class YuanjaiMapPage extends StatefulWidget {
  const YuanjaiMapPage({super.key});

  @override
  State<YuanjaiMapPage> createState() => _YuanjaiMapPageState();
}

class _YuanjaiMapPageState extends State<YuanjaiMapPage> {
  ...
  static const LatLng destination = LatLng(15.28021234, 104.8343741);
